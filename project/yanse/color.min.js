...
function(a, b) {
    ...
    o.extend = o.fn.extend = function() {
        ...
        h++), "object" == typeof g || o.isFunction(g) || (g = {}), h === i && (g = this, h--); i > h; h++) {
    ...
    o.fn.extend({
        ...
        closest: function(a, b) {
            for (var c, d = 0,
            e = this.length,
            f = [], g = u.test(a) || "string" != typeof a ? o(a, b || this.context) : 0; e > d; d++) {
    ...
    o.fn.extend({
        text: function(a) {
            return J(this,
            function(a) {
                return void 0 === a ? o.text(this) : this.empty().each(function() { (1 === this.nodeType || 11 === this.nodeType || 9 === this.nodeType) && (this.textContent = a)
                })
            },
...
(function() {
    ...
    "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = ao), exports._ = ao) : ak._ = ao,
    ao.VERSION = "1.6.0";
    ...
    ao.map = ao.collect = function(d, a, b) {
        var c = [];
        return null == d ? c: ai && d.map === ai ? d.map(a, b) : (X(d,
        function(g, e, f) {
    ...
    ao.reduceRight = ao.foldr = function(j, f, g, h) {
        ...
        function(e, i, a) {
            i = b ? b[--d] : --d,
            c ? g = f.call(h, g, j[i], i, a) : (g = j[i], c = !0)
        }), !c) {
            throw new TypeError(J)
        }
        return g
    ...
    ao.filter = ao.select = function(d, a, b) {
        var c = [];
        return null == d ? c: ar && d.filter === ar ? d.filter(a, b) : (X(d,
        function(g, e, f) {
    ...
    ao.every = ao.all = function(d, b, c) {
        b || (b = ao.identity);
        var a = !0;
        return null == d ? a: av && d.every === av ? d.every(b, c) : (X(d,
        function(g, f, e) {
    ...
    var an = ao.some = ao.any = function(d, b, c) {
        b || (b = ao.identity);
        var a = !1;
        return null == d ? a: al && d.some === al ? d.some(b, c) : (X(d,
        function(g, f, e) {
            return a || (a = b.call(c, g, f, e)) ? ag: void 0
        }), !!a)
    };
    ao.contains = ao.include = function(b, a) {
        return null == b ? !1 : Z && b.indexOf === Z ? b.indexOf(a) != -1 : an(b,
        function(c) {
            return c === a
        })
    },
    ...
    var L = function(c, a, b) {
        return a && ao.every(c, ao.isArray) ? aw.apply(b, c) : (X(c,
        function(d) {
    ...
    ao.partition = function(d, a) {
        ...
        c = [];
        return X(d,
        function(e) { (a(e) ? b: c).push(e)
        }),
        [b, c]
    },
    ao.uniq = ao.unique = function(j, f, g, h) {
        ao.isFunction(f) && (h = g, g = f, f = !1);
        var c = g ? ao.map(j, g, h) : j,
        d = [],
        b = [];
        return X(c,
        function(a, i) { (f ? i && b[b.length - 1] === a: ao.contains(b, a)) || (b.push(a), d.push(j[i]))
        }),
        d
    },
    ao.union = function() {
    ...
    ao.partial = function(b) {
        ...
        return function() {
            for (var f = 0,
            g = a.slice(), c = 0, d = g.length; d > c; c++) {
    ...
    ao.throttle = function(f, m, b) {
        ...
        return function() {
            ...
            return h = this,
            l = arguments,
            0 >= c ? (clearTimeout(k), k = null, d = a, g = f.apply(h, l), h = l = null) : k || b.trailing === !1 || (k = setTimeout(j, c)),
            g
        }
    },
    ao.debounce = function(f, m, b) {
        ...
        return function() {
            ...
            k = ao.now();
            var a = b && !h;
            return h || (h = setTimeout(j, m)),
            a && (d = f.apply(g, l), g = l = null),
            d
        }
    },
    ao.once = function(c) {
    ...
    ao.invert = function(f) {
        for (var b = {},
        c = ao.keys(f), d = 0, a = c.length; a > d; d++) {
            b[f[c[d]]] = c[d]
        }
        return b
    },
    ...
    ao.pick = function(c) {
        var a = {},
        b = aw.apply(au, aj.call(arguments, 1));
        return X(b,
        function(d) {
            d in c && (a[d] = c[d])
        }),
    ...
    ao.omit = function(d) {
        var b = {},
        c = aw.apply(au, aj.call(arguments, 1));
        for (var a in d) {
    ...
    ao.clone = function(a) {
        return ao.isObject(a) ? ao.isArray(a) ? a.slice() : ao.extend({},
        a) : a
    },
    ao.tap = function(b, a) {
        return a(b),
    ...
    var G = function(g, q, b, k) {
        ...
        g instanceof ao && (g = g._wrapped),
        q instanceof ao && (q = q._wrapped);
        var p = am.call(g);
        if (p != am.call(q)) {
            return ! 1
        }
    ...
    X(["Arguments", "Function", "String", "Number", "Date", "RegExp"],
    function(a) {
        ao["is" + a] = function(b) {
    ...
    ao.each(["escape", "unescape"],
    function(a) {
        ao[a] = function(b) {
            return null == b ? "": ("" + b).replace(P[a],
            function(c) {
                return C[a][c]
            })
        }
    ...
    ao.mixin = function(a) {
        ...
        function(b) {
            ...
            ao.prototype[b] = function() {
                var d = [this._wrapped];
                return ay.apply(d, arguments),
                Y.call(this, c.apply(ao, d))
            }
        })
    };
    var K = 0;
    ...
    ao.template = function(f, m, b) {
        var h;
        b = ao.defaults({},
        b, ao.templateSettings);
        var l = new RegExp([(b.escape || ah).source, (b.interpolate || ah).source, (b.evaluate || ah).source].join("|") + "|$", "g"),
        g = 0,
        k = "__p+='";
        f.replace(l,
        function(c, i, n, a, p) {
            return k += f.slice(g, p).replace(V,
            function(e) {
                return "\\" + W[e]
            }),
...
function() {
    ...
    f = {
        ...
        renderUI: function() {
            ...
            g = a ? window.innerHeight: window.innerWidth;
            g -= 20,
            g = Math.min(g, 500),
            e.width(g).height(g),
            this.el.show()
        ...
        initEvent: function() {
            var b = "ontouchstart" in document.documentElement ? "touchend": "click",
            a = this;
            ...
            d.pause.on(b, _.bind(this.pause, this)),
            d.resume.on(b, _.bind(this.resume, this)),
            d.start.on(b, _.bind(this.start, this)),
            d.back.on(b, _.bind(this.back, this)),
            d.share.on(b, _.bind(this.share, this))
        },
        start: function() {
            showAdDivs(false);
            this.time > 5 && d.time.removeClass("danger"),
            d.dialog.hide(),
            this._pause = !1,
        ...
        renderMap: function() {
            if (!this._pause) {
                var a = this.lvMap * this.lvMap,
                h = "",
                g = "lv" + this.lvMap;
                _(a).times(function() {
                    h += "<span></span>"
                }),
                e.attr("class", g).html(h),
        ...
        gameOver: function() {
            ...
            this.lastLv = this.lv,
            this.lastGameTxt = h.txt,
            this.lastGamePercent = h.percent,
            d.d_share.hide().find("h3").text(this.lastGameTxt),
            d.d_share.hide().find("h2").text(this.lv + "分"),
            d.d_content.hide(),
            d.d_gameover.show().find("h3").text(this.lastGameTxt),
            d.d_gameover.show().find("h2").text(this.lv + "分"),
            e.find("span").fadeOut(1000,
            function() {
                d.dialog.fadeIn()
            }),
            this._pause = !0,
            this.reset();
            document.title = Game.lastLv > 0 ? "我闯过" + (Game.lastLv) + "关，我的视力超过" + Game.lastGameTxt + "！世界上不出10人能达到，不服来战！": "保护眼睛，16分以下不要再玩手机了！";
            showAdDivs(true);
            if ($("#appendflag").val() > 0) {
                var g = '';
                var b = '';
        ...
        nextLv: function() {
            ...
            d.time.text(parseInt(this.time)),
...
function(e) {
    ...
    f = {
        ...
        initEvent: function() {
            var self = this;
            d.play.on("ontouchstart" in document.documentElement ? "touchstart": "click",
            function() {
                showAdDivs(false);
                var c = $(this).data("type") || "color";
                d.index.hide(),
                Game.init(c, d.room, self)
            })
        }
    };
    f.init(),
...
function() {
    ...
    i = $("#help_color"),
    h = {
        lvT: ["林蛙精", "兔兔精", "狐狸精", "狼精", "虎精", "黑熊精", "怪兽", "仙兽", "神兽"],
        render: function(l, k) {
            this.lv = k,
            j.hide(),
            i.show();
            var d = _config.color.lvMap[k] || _.last(_config.color.lvMap);
            this.d = 15 * Math.max(9 - d, 1),
            this.d = k > 20 ? 10 : this.d,
            this.d = k > 40 ? 8 : this.d,
            this.d = k > 50 ? 5 : this.d;
            var c = Math.floor(Math.random() * l * l),
            b = this.getColor(255 - this.d),
            a = this.getLvColor(b[0]);
            g.find(f).css("background-color", b[1]).data("type", "b"),
            g.find(f).eq(c).css("background-color", a[1]).data("type", "a")
        },
        getColor: function(e) {
            var d = [Math.round(Math.random() * e), Math.round(Math.random() * e), Math.round(Math.random() * e)],
            k = "rgb(" + d.join(",") + ")";
            return [d, k]
        },
        ...
        getGameOverText: function(l) {
            var k = 15 > l ? 0 : Math.ceil((l - 15) / 5),
            o = this.lvT[k] || _.last(this.lvT),
            n = o,
            m = 2 * l * 0.95;
            return m = m > 90 ? 90 + 0.15 * l: m,
            m = Math.min(m, 100),
            {
                txt: n,
                percent: m.toFixed(2)
