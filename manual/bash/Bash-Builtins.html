...
<head>
<title>Bash Reference Manual: Bash Builtins</title>

<meta name="description" content="Bash Reference Manual: Bash Builtins">
<meta name="keywords" content="Bash Reference Manual: Bash Builtins">
...
<link href="Modifying-Shell-Behavior.html#Modifying-Shell-Behavior" rel="next" title="Modifying Shell Behavior">
<link href="Bourne-Shell-Builtins.html#Bourne-Shell-Builtins" rel="previous" title="Bourne Shell Builtins">
<style type="text/css">
<!--
...
<div class="header">
<p>
Next: <a href="Modifying-Shell-Behavior.html#Modifying-Shell-Behavior" accesskey="n" rel="next">Modifying Shell Behavior</a>, Previous: <a href="Bourne-Shell-Builtins.html#Bourne-Shell-Builtins" accesskey="p" rel="previous">Bourne Shell Builtins</a>, Up: <a href="Shell-Builtin-Commands.html#Shell-Builtin-Commands" accesskey="u" rel="up">Shell Builtin Commands</a> &nbsp; [<a href="index.html#SEC_Contents" title="Table of contents" rel="contents">Contents</a>][<a href="Indexes.html#Indexes" title="Index" rel="index">Index</a>]</p>
</div>
<hr>
...
<div class="example">
<pre class="example">alias [<code>-p</code>] [<var>name</var>[=<var>value</var>] &hellip;]
</pre></div>
...
Aliases are described in <a href="Aliases.html#Aliases">Aliases</a>.
</p>
</dd>
...
<p>Display current Readline (see <a href="Command-Line-Editing.html#Command-Line-Editing">Command Line Editing</a>)
key and function bindings,
bind a key sequence to a Readline function or macro,
or set a Readline variable.
Each non-option argument is a command as it would appear in a
Readline initialization file (see <a href="Readline-Init-File.html#Readline-Init-File">Readline Init File</a>),
...
<div class="example">
<pre class="example">declare [-aAfFilrtux] [-p] [<var>name</var>[=<var>value</var>] &hellip;]
</pre></div>
...
(see <a href="The-Shopt-Builtin.html#The-Shopt-Builtin">The Shopt Builtin</a>), the source file name and line number where
...
<dl compact="compact">
<dt><code>-a</code></dt>
<dd><p>Each <var>name</var> is an indexed array variable (see <a href="Arrays.html#Arrays">Arrays</a>).
</p>
</dd>
<dt><code>-A</code></dt>
<dd><p>Each <var>name</var> is an associative array variable (see <a href="Arrays.html#Arrays">Arrays</a>).
</p>
</dd>
<dt><code>-f</code></dt>
...
an integer; arithmetic evaluation (see <a href="Shell-Arithmetic.html#Shell-Arithmetic">Shell Arithmetic</a>) is
...
as with the <code>local</code> command, unless the &lsquo;<samp>-g</samp>&rsquo; option is used.
...
using the compound assignment syntax (see <a href="Arrays.html#Arrays">Arrays</a>),
...
a special builtin (see <a href="Special-Builtins.html#Special-Builtins">Special Builtins</a>).
</p>
...
rules given below in <a href="Shell-Arithmetic.html#Shell-Arithmetic">Shell Arithmetic</a>.  If the
...
<div class="example">
<pre class="example">mapfile [-n <var>count</var>] [-O <var>origin</var>] [-s <var>count</var>] [-t] [-u <var>fd</var>] [
...
<dt><code>-t</code></dt>
<dd><p>Remove a trailing newline from each line read.
</p></dd>
<dt><code>-u</code></dt>
...
(except that &lsquo;<samp>\c</samp>&rsquo; terminates output, backslashes in
&lsquo;<samp>\'</samp>&rsquo;, &lsquo;<samp>\&quot;</samp>&rsquo;, and &lsquo;<samp>\?</samp>&rsquo; are not removed, and octal escapes
beginning with &lsquo;<samp>\0</samp>&rsquo; may contain up to four digits).
</p></dd>
<dt><code>%q</code></dt>
...
<div class="example">
<pre class="example">read [-ers] [-a <var>aname</var>] [-d <var>delim</var>] [-i <var>text</var>] [-n <var>nchars</var>] [-N <var>nchars</var>] [-p <var>prompt</var>] [-t <var>timeout</var>] [-u <var>fd</var>] [<var>name</var> &hellip;]
</pre></div>
...
<dt><code>-e</code></dt>
<dd><p>Readline (see <a href="Command-Line-Editing.html#Command-Line-Editing">Command Line Editing</a>) is used to obtain the line.
...
<div class="example">
<pre class="example">readarray [-n <var>count</var>] [-O <var>origin</var>] [-s <var>count</var>] [-t] [-u <var>fd</var>] [
-C <var>callback</var>] [-c <var>quantum</var>] [<var>array</var>]
</pre></div>
<p>Read lines from the standard input into the indexed array variable <var>array</var>,
or from file descriptor <var>fd</var>
...
<p>A synonym for <code>.</code> (see <a href="Bourne-Shell-Builtins.html#Bourne-Shell-Builtins">Bourne Shell Builtins</a>).
</p>
</dd>
...
<div class="example">
<pre class="example">typeset [-afFrxi] [-p] [<var>name</var>[=<var>value</var>] &hellip;]
</pre></div>
...
<div class="example">
<pre class="example">ulimit [-abcdefilmnpqrstuvxHST] [<var>limit</var>]
</pre></div>
