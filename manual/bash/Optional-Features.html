...
<head>
<title>Bash Reference Manual: Optional Features</title>

<meta name="description" content="Bash Reference Manual: Optional Features">
<meta name="keywords" content="Bash Reference Manual: Optional Features">
...
<link href="Operation-Controls.html#Operation-Controls" rel="previous" title="Operation Controls">
<style type="text/css">
<!--
...
<div class="header">
<p>
Previous: <a href="Operation-Controls.html#Operation-Controls" accesskey="p" rel="previous">Operation Controls</a>, Up: <a href="Installing-Bash.html#Installing-Bash" accesskey="u" rel="up">Installing Bash</a> &nbsp; [<a href="index.html#SEC_Contents" title="Table of contents" rel="contents">Contents</a>][<a href="Indexes.html#Indexes" title="Index" rel="index">Index</a>]</p>
</div>
<hr>
...
<p>All of the following options except for &lsquo;<samp>disabled-builtins</samp>&rsquo; and
...
(see <a href="Looping-Constructs.html#Looping-Constructs">Looping Constructs</a>).
</p>
</dd>
...
See <a href="Brace-Expansion.html#Brace-Expansion">Brace Expansion</a>, for a complete description.
</p>
</dd>
...
(see <a href="Pipelines.html#Pipelines">Pipelines</a>).
...
See <a href="Bash-Builtins.html#Bash-Builtins">Bash Builtins</a>, for details of the <code>builtin</code> and
...
above under <a href="Pattern-Matching.html#Pattern-Matching">Pattern Matching</a>.
</p>
</dd>
<dt><code>--enable-extended-glob-default</code></dt>
<dd><p>Set the default value of the <var>extglob</var> shell option described
above under <a href="The-Shopt-Builtin.html#The-Shopt-Builtin">The Shopt Builtin</a> to be enabled.
</p>
</dd>
<dt><code>--enable-help-builtin</code></dt>
<dd><p>Include the <code>help</code> builtin, which displays help on shell builtins and
variables (see <a href="Bash-Builtins.html#Bash-Builtins">Bash Builtins</a>).
</p>
</dd>
<dt><code>--enable-history</code></dt>
<dd><p>Include command history and the <code>fc</code> and <code>history</code>
builtin commands (see <a href="Bash-History-Facilities.html#Bash-History-Facilities">Bash History Facilities</a>).
</p>
</dd>
<dt><code>--enable-job-control</code></dt>
<dd><p>This enables the job control features (see <a href="Job-Control.html#Job-Control">Job Control</a>),
...
when used in redirections (see <a href="Redirections.html#Redirections">Redirections</a>).
</p>
</dd>
<dt><code>--enable-process-substitution</code></dt>
<dd><p>This enables process substitution (see <a href="Process-Substitution.html#Process-Substitution">Process Substitution</a>) if
...
strings.  See <a href="Printing-a-Prompt.html#Printing-a-Prompt">Printing a Prompt</a>, for a complete list of prompt
string escape sequences.
</p>
</dd>
<dt><code>--enable-readline</code></dt>
<dd><p>Include support for command-line editing and history with the Bash
version of the Readline library (see <a href="Command-Line-Editing.html#Command-Line-Editing">Command Line Editing</a>).
</p>
</dd>
...
<a href="The-Restricted-Shell.html#The-Restricted-Shell">The Restricted Shell</a>, for a description of restricted mode.
</p>
</dd>
<dt><code>--enable-select</code></dt>
<dd><p>Include the <code>select</code> compound command, which allows the generation of
simple menus (see <a href="Conditional-Constructs.html#Conditional-Constructs">Conditional Constructs</a>).
</p>
</dd>
...
<dd><p>Make Bash <small>POSIX</small>-conformant by default (see <a href="Bash-POSIX-Mode.html#Bash-POSIX-Mode">Bash POSIX Mode</a>).
</p>
</dd>
...
See <a href="Bash-Builtins.html#Bash-Builtins">Bash Builtins</a>, for a description of the escape sequences that
