...
<link href="Shell-Arithmetic.html#Shell-Arithmetic" rel="previous" title="Shell Arithmetic">


<meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0,maximum-scale=1.0,user-scalable=no">
<link rel="stylesheet" href="{{ site.url }}/stylesheets/bootstrapv3.min.css" type="text/css" />
<link rel="stylesheet" href="{{ site.url }}/stylesheets/default.min.css" type="text/css" />
...
<script src="{{ site.url }}/javascripts/jquery-1.7.1.min.min.js" type="text/javascript"></script>
<script src="{{ site.url }}/javascripts/bootstrapv3.min.js" type="text/javascript" ></script>
<script src="{{ site.url }}/javascripts/bootstrap-paginator.min.js" type="text/javascript"></script>
<script src="{{ site.url }}/javascripts/main.js" type="text/javascript"></script>
...
<div class="header">
<p>
Next: <a href="Arrays.html#Arrays" accesskey="n" rel="next">Arrays</a>, Previous: <a href="Shell-Arithmetic.html#Shell-Arithmetic" accesskey="p" rel="previous">Shell Arithmetic</a>, Up: <a href="Bash-Features.html#Bash-Features" accesskey="u" rel="up">Bash Features</a> &nbsp; [<a href="index.html#SEC_Contents" title="Table of contents" rel="contents">Contents</a>][<a href="Indexes.html#Indexes" title="Index" rel="index">Index</a>]</p>
</div>
<hr>
<a name="Aliases-1"></a>
