...
<head>
<title>Bash Reference Manual: Bash Variables</title>

<meta name="description" content="Bash Reference Manual: Bash Variables">
<meta name="keywords" content="Bash Reference Manual: Bash Variables">
...
<link href="Bash-Features.html#Bash-Features" rel="next" title="Bash Features">
<link href="Bourne-Shell-Variables.html#Bourne-Shell-Variables" rel="previous" title="Bourne Shell Variables">
<style type="text/css">
<!--
...
<div class="header">
<p>
Previous: <a href="Bourne-Shell-Variables.html#Bourne-Shell-Variables" accesskey="p" rel="previous">Bourne Shell Variables</a>, Up: <a href="Shell-Variables.html#Shell-Variables" accesskey="u" rel="up">Shell Variables</a> &nbsp; [<a href="index.html#SEC_Contents" title="Table of contents" rel="contents">Contents</a>][<a href="Indexes.html#Indexes" title="Index" rel="index">Index</a>]</p>
</div>
<hr>
...
(see <a href="Job-Control-Variables.html#Job-Control-Variables">Job Control Variables</a>).
</p>
<dl compact="compact">
<dt><code>BASH</code>
<a name="index-BASH"></a>
...
<dd><p>Incremented by one each time a subshell or subshell environment is spawned.
...
<dd><p>A readonly array variable (see <a href="Arrays.html#Arrays">Arrays</a>)
...
<dd><p>The maximum number of lines contained in the history file.  When this
...
strings preceded by a &lsquo;<samp>$</samp>&rsquo; (see <a href="Locale-Translation.html#Locale-Translation">Locale Translation</a>).
</p>
</dd>
...
<dd><p>An array variable (see <a href="Arrays.html#Arrays">Arrays</a>)
...
<dd><p>If this variable is in the environment when <code>bash</code> starts, the shell
...
If it is set while the shell is running, <code>bash</code> enables <small>POSIX</small> mode,
as if the command
</p><div class="example">
...
<code>\W</code> prompt string escapes (see <a href="Printing-a-Prompt.html#Printing-a-Prompt">Printing a Prompt</a>).
...
when the <samp>-x</samp> option is set (see <a href="The-Set-Builtin.html#The-Set-Builtin">The Set Builtin</a>).
...
with &lsquo;<samp>bind -x</samp>&rsquo; (see <a href="Bash-Builtins.html#Bash-Builtins">Bash Builtins</a>).
</p>
</dd>
