...
新增的缓存层和原先聚合成的区别有很多, 这些区别也影响很严, 其中前三点还是没办法避免的.   
...
>  
> 多阶HASH简介
> 对于简单的HASH表, key冲突了一般是使用链表连起来, 固定内存也可以实现,但是略微复杂, 且冲突后查找性能就变成线性的了.  
...
其实上线版本号系统后命中率提升的并没有那么多, 但是版本号系统上线之后我就可以把热key这个功能关闭了.  
